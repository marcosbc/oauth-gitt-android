...
public class UrbankOAuthDialog extends Dialog {
    ...
    public UrbankOAuthDialog(Context context, String url, GenericDialogListener listener) {
        super(context);
        mUrl = url;
        mListener = listener;
    }
    ...
    private void setUpTitle() {
       ...
       // Drawable icon = getContext().getResources().getDrawable(R.drawable.img_icon_facebooklogin_header_small);
        mTitle = new TextView(getContext());
        mTitle.setText("URBANK OAUTH");
    ...
    private void setUpWebView() {
        ...
        mWebView.setWebViewClient(new UrbankOAuthDialog.OAuthWebViewClient());
